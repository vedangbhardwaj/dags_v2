...
def result_generation(dataset_name):
    ...
    truncate_table("verdict_result_rule_trunc", "COMBINATION_MODEL_XG".lower())
    write_to_snowflake(verdict_data, "verdict_result_rule_trunc", "COMBINATION_MODEL_XG".lower())
    return
